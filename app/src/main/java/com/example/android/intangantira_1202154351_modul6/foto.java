    ...
    public void savepost(View view) {
        ...
        nTask.addOnSuccessListener(new OnSuccessListener<UploadTask.TaskSnapshot>() {
            ...
            public void onSuccess(UploadTask.TaskSnapshot taskSnapshot) {
                ...
                databasedua usr = new databasedua(gmbr, editTitle.getText().toString(), editCaption.getText().toString(), currentuser);
                ...
                nDatabaseRef.push().setValue(usr).addOnSuccessListener(new OnSuccessListener<Void>() {
                    ...
                    public void onSuccess(Void aVoid) {
                        Toast.makeText(foto.this, "Photo Uploaded", Toast.LENGTH_SHORT).show();
                        finish();
                    }
            ...
            public void onFailure(@NonNull Exception e) {
                ...
                Toast.makeText(foto.this, "Cannot upload", Toast.LENGTH_SHORT).show();
                pd.dismiss();
            }
        });
