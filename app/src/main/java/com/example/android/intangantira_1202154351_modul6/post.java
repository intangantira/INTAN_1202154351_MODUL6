...
public class post extends AppCompatActivity {
    ...
    adaptersatu adapterC;
    ArrayList<databasesatu> list;
    DatabaseReference nDatabaseRef;
    ProgressDialog pd;
    String nUsr, imageid;

    public post() {
        adapterC = new adaptersatu(this, list);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        nDatabaseRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onChildAdded(DataSnapshot dataSnapshot, String s) {
                databasesatu crnt = dataSnapshot.getValue(databasesatu.class);
    ...
    public void btnKomen(View view) {
        ...
        pd.show();
        //inisialisasi objek
        databasesatu cmnt = new databasesatu(nUsr, comments.getText().toString(), imageid);
